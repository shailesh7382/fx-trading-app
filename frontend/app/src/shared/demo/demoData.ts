import type { AuthenticatedUser, FxRate, LookupItem, Trade } from '@/shared/types';

const nowIso = (): string => new Date().toISOString();

const seedRates: FxRate[] = [
...
export function getFallbackRates(): FxRate[] {
...
export function simulateMarketSnapshot(previousRates: FxRate[] = getFallbackRates()): FxRate[] {
...
export const fallbackCustomers: LookupItem[] = [
...
export const fallbackRelationshipManagers: LookupItem[] = [
  { id: 1, name: 'Amelia Hart' },
  { id: 2, name: 'Noah Cheng' },
  { id: 3, name: 'Priya Raman' },
];

export const fallbackSales: LookupItem[] = [
  { id: 1, name: 'Sofia Miller' },
  { id: 2, name: 'Marcus Tan' },
  { id: 3, name: 'Daniel Brooks' },
];

export function createDemoUser(username: string = 'demo.trader'): AuthenticatedUser {
  return {
    username,
    userType: 'TRADER',
