...
import { formatCurrency, formatNotional, getCurrencyCodes } from '@/shared/utils/formatters';
...
function Portfolio() {
  ...
  const portfolio = useMemo(() => {
    ...
    trades.forEach((trade) => {
      ...
      const customerKey = trade.customer || 'Desk order';
      customerTotals[customerKey] = (customerTotals[customerKey] || 0) + usdEquivalent;
    });
