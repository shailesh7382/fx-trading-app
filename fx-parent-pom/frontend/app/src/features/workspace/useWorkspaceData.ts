...
import { fetchFxPrices, fetchLimitOrders, fetchNotifications } from '@/shared/api/client';
import { getFallbackRates, simulateMarketSnapshot } from '@/shared/demo/demoData';
import type { AppNotification, FxRate, LimitOrder, NormalizedRate, NotificationsPayload } from '@/shared/types';

export interface RefreshOptions {
  forceRates?: boolean;
}

/** Everything `WorkspaceLayout` publishes to its routed screens through the router outlet. */
...
/** Typed view of the workspace data that `WorkspaceLayout` passes down the router outlet. */
